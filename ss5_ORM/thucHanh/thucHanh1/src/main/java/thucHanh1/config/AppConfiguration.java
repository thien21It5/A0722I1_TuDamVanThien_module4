...
//    }
    ...
    public DriverManagerDataSource getDataSource() {
        ...
        datasource.setUrl("jdbc:mysql://localhost:3306/customerManager?useSSL=false&useUnicode=true&characterEncoding=utf8");
        datasource.setUsername("A0722I1");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan(new String[]{"thucHanh1.entity"});
